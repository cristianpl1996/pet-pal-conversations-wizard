...
interface WhatsAppClinicAreasStepProps {
  onNext: (areas: ClinicArea[]) => void;
  onBack: () => void;
  guidedMode: boolean;
}

export function WhatsAppClinicAreasStep({ onNext, onBack, guidedMode }: WhatsAppClinicAreasStepProps) {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Cuando un cliente escribe por WhatsApp, ¿a qué áreas podrías redirigirlo desde recepción?
        </p>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 mt-1">
              Al crear estas áreas, tu agente de WhatsApp podrá redirigir automáticamente las consultas 
