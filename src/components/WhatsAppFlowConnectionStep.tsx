...
import { ArrowRight, Edit, MessageSquare, Users, Save } from 'lucide-react';
...
interface WhatsAppFlowConnectionStepProps {
...
export function WhatsAppFlowConnectionStep({ onNext, onBack, areas, guidedMode }: WhatsAppFlowConnectionStepProps) {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Ahora conecta la recepción con las áreas que creaste. Así sabremos a quién redirigir cada conversación de WhatsApp.
        </p>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-xl">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center">
            <Card className="w-64 bg-green-500 text-white border-green-600">
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2">
                  <MessageSquare className="w-5 h-5" />
                  <span className="font-medium">Recepción WhatsApp</span>
                </div>
                <p className="text-sm text-green-100 mt-1">Punto de entrada principal</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                Tu agente de WhatsApp redirigirá automáticamente las conversaciones según las condiciones que definiste. 
